...
<div class="app-container">
    ...
    <form action="./submit_order.php" method="post" id="checkout-form">
        <input type="hidden" form="checkout-form" name="" value="">
    </form>

    <main class="main-content">
        <div class="screen active">

            <!-- Return to the cart processing page -->
            <a href="bag_functions.php" class="back-btn" style="position:fixed;top:24px;left:24px;z-index:200;text-decoration:none;display:flex;align-items:center;justify-content:center;width:36px;height:36px;">
            ...
            <div class="checkout-content">
                ...
                <div class="section">
                    ...
                    <input type="text" id="pickupName" class="text-input" placeholder="ex. Jordan Doe" autocomplete="given-name">
                ...
                <div class="section">
                    ...
                    <div class="checkout-order-items">
                        ...
                        <div class="order-item">
                            <div class="order-item-header">
                                <span><?= $item["count"] ?>x <?= $target_item["name"] ?></span>
                                <span>$<?= $item_price ?></span>
                            </div>
                            <div class="order-item-details"><?= $extras ?></div>
                        </div>
                        <?php } ?>
                    </div>
                    ...
                    <div class="summary-row">
                        <span>Tax</span>
                        <span id="sumTax">$<?= $tax ?></span>
                    </div>

                    <div class="summary-row total-row">
                        <span>Total</span>
                        <span id="sumTotal">$<?= number_format($subtotal + $tax, 2) ?></span>
                    </div>
                </div>
                ...
                <div class="section">
                    ...
                    <div class="tip-options">
                        ...
                        <label class="tip-btn" onclick="selectTip(this)">
                            No Tip
                            <input type="radio" data-tip="0" form="checkout-form" name="tip" value="0">
                        </label>

                        <label class="tip-btn" onclick="selectTip(this)">
                            15%
                            <input type="radio" data-tip="15" form="checkout-form" name="tip" value="<?= $subtotal * 0.15 ?>">
                        </label>

                        <label class="tip-btn" onclick="selectTip(this)">
                            20%
                            <input type="radio" data-tip="20" form="checkout-form" name="tip" value="<?= $subtotal * 0.2 ?>">
                        </label>
                    </div>
