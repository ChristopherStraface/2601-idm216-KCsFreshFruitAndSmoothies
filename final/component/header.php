<header class="header">
    ...
    <div class="header-content">
        ...
        <a href="./index.php">
            <img src="./images/KC's.svg" alt="KC's Smoothie Bar" class="logo">
        </a>

        <div class="header-actions">

            <a href="./bag_functions.php" class="icon-btn" aria-label="View bag">
            ...
            <button class="icon-btn disabled" aria-label="Profile">
                <svg class="icon" viewBox="0 0 32 32" fill="none">
