  ...
  <div id="app" class="app-container">
    ...
    <header id="header" class="header">
      <div class="header-content">
        <img src="./img/KC’s.svg" alt="KC's Smoothie Bar" class="logo">
      ...
      <div id="customizeScreen" class="screen">
        ...
        <div class="customize-content">
          ...
          <div class="customize-image">
            <img id="customizeImage" src="./img/smoothie.avif" alt="Smoothie">
          </div>
          ...
          <div class="section">
            ...
            <div class="checkbox-grid">
              ...
              <label class="checkbox-label">
                <input type="checkbox" class="ingredient-checkbox" value="Taro">
                <span class="checkbox-custom"></span>
                <span>Taro</span>
              </label>
            </div>
          ...
          <div class="section">
            ...
            <div class="checkbox-grid">
              ...
              <label class="checkbox-label">
                <input type="checkbox" class="addon-checkbox" value="Yogurt">
                <span class="checkbox-custom"></span>
                <span>Yogurt</span>
              </label>
            </div>
        ...
        <div class="checkout-content">
          <h2 class="screen-title">Checkout</h2>
           ...
           <div class="section">
            ...
            <!-- Time Picker Dropdown (hidden by default) -->
            <div id="timePickerDropdown" class="time-picker-dropdown hidden">
              ...
              <select id="scheduledTime" class="time-picker-select">
